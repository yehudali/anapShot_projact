# SnapShot — מודיעין מצבי בזמן אמת

> **דע היכן האנשים שלך נמצאים — ברגע שזה חשוב.**

SnapShot היא מערכת קוד פתוח לתודעה מצבית בזמן אמת, המיועדת לפעולות שטח. המערכת מאפשרת למפקדים ולרכזים לעקוב אחר מיקום ה-GPS של כל יחידה פעילה על גבי מפה משותפת — מרגע פתיחת האירוע ועד סיומו.
...
**SnapShot מדווח מיקום רק כשנפתח אירוע — ומפסיק מיד עם סיומו.**

זו החלטה תכנונית מכוונת, מתוך שלושה טעמים עיקריים:

### 1. אבטחה מבצעית (חיילים ולוחמים)
דיווח GPS רציף חושף את מיקום הכוחות לאורך זמן. מיקום שנקלט על-ידי גורם עוין — ולו לרגע — עלול לגרום נזק קשה. בSnapShot, המיקום מועבר **רק כשנפתח אירוע מבצעי מוגדר**, ומיד עם סיומו — הדיווח נפסק לחלוטין.
...
SnapShot הופך כל סמארטפון למכשיר דיווח GPS. כשנפתח אירוע:
